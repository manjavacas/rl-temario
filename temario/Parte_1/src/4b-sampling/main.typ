...
#slide(title: [#on])[
  ...
  #box(height:400pt)[
    ...
    #shadow[Los métodos #emoji.silhouette #alert[*_on-policy_*] emplean *una única política*.]
      ...
      #text(size:18pt)[Esta política _aspira_ a un comportamiento óptimo, pero siempre debe reservar *cierta probabilidad de explorar*.]
...
#slide(title:[#imp])[
  ...
  #text(size:18pt)[ 
    #table(
      ...
      [$frac(p_cal(D) (Y_i), p_cal(D') (Y_i))$ = 1], [Misma probabilidad en $cal(D)$ y $cal(D')$. La aportación no varía.],  
      [$frac(p_cal(D) (Y_i), p_cal(D') (Y_i))$ > 1], [$Y_i$ es más probable en la distribución original $cal(D)$, por lo que su peso es mayor.], 
      [$frac(p_cal(D) (Y_i), p_cal(D') (Y_i))$ < 1], [$Y_i$ es más probable en la distribución modificada $cal(D')$, por lo que su peso es menor.], 
      [$frac(p_cal(D) (Y_i), p_cal(D') (Y_i))$ = 0], [$Y_i$ no aporta nada, porque no puede obtenerse en la distribución original.],      
